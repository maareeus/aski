...
public sealed class AuthService
{
    ...
    /// <summary>Login. Ritorna null se ok, altrimenti il messaggio d'errore.</summary>
    public async Task<string?> LoginAsync(string email, string password)
    {
        ...
        // Solo i clienti accedono al portale.
        if (!auth.User.Roles.Contains("Client"))
            return "Questo portale è riservato ai clienti.";
